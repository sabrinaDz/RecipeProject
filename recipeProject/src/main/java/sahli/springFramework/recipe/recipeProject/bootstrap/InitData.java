package sahli.springFramework.recipe.recipeProject.bootstrap;
...
import sahli.springFramework.recipe.recipeProject.model.Difficulty;
import sahli.springFramework.recipe.recipeProject.model.Ingredient;
import sahli.springFramework.recipe.recipeProject.model.Notes;
...
public class InitData implements ApplicationListener<ContextRefreshedEvent>{
	...
	public InitData(CategoryRepository categoryRepository,RecipeRepository recipeRepository,
	...
	private List<Recipe>createRecipes(){
		...
		//get UOMs
        Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.getByUom("Pinch");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> tableSpoonUomOptional = unitOfMeasureRepository.getByUom("Tablespoon");

        if(!tableSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> teaSpoonUomOptional = unitOfMeasureRepository.getByUom("Teaspoon");

        if(!teaSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.getByUom("Dash");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> pintUomOptional = unitOfMeasureRepository.getByUom("Pint");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasureRepository.getByUom("Cup");
